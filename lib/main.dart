...
import 'package:cal_upeu/comp/CustomAppBarX.dart';
  ...
  void resultOperacion(String text) {
    setState(() {
      switch (operador) {
        ...
        case "^": // Potenciación
          _controller.text = pow(int.parse(valorAnt), int.parse(_controller.text)).toString();
          break;
      }
    });
  }
...
//Aqui codigo
  //hecho por Jhon alexander Chambi Vilca
